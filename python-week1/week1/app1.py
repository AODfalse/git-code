...
with gr.Blocks(title="AI电影顾问", theme=gr.themes.Soft()) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=2):
            ...
            stats = gr.Textbox(label="系统统计", value=recommender.get_stats, every=5)
...
async def api_predict(request: Request):
    ...
    try:
        ...
        # 检查请求格式
        if "data" not in body:
            raise HTTPException(status_code=422, detail="Missing 'data' field in request")
